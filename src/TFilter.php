...
class TFilter extends TExpression
{
	...
	public function __construct($variable, $operator, $value)
	{
		...
		$this->variable = ($variable instanceof TExpression)?$variable->dump():$variable;
	...
	private function transform($value)
	{
		...
		// caso seja uma instancia de TTableAndField
        else if($value instanceof TExpression)
        {
            $result = $value->dump();
        }
		else if($value instanceof TSqlInstruction)
		{
